...
setwd("F:/Side_project/african_data_workshop/General/Dataset examples - Exemples de jeux de donnée/stem_NPP")
...
acj_01A <- NPPacw_census(census, plotname, census1_year, census2_year, allometric_option="Default", height_correction_option="Default") 
acj_01A  <- NPPacw_census(census, plotname, allometric_option="Default", height_correction_option="Default", census1_year, census2_year)
